...
# 3. 组合业务工具：把基础查询 + RAG 检索 + 客服建议合成一个业务处理结果。
...
# 7. 投诉更新工具：包装 db.py 的 update_complaint()。
